...
@WebServlet("/frontCallback")
public class PaymentFrontCallbackController extends HttpServlet
{
	private static final Logger LOG = Logger.getLogger(PaymentFrontCallbackController.class);

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException
	{
		LOG.info("third party FRONT callback...");
